...
const WhyUs = () => {
    return (
        <div className="Why-Us Container p-4 mt-3 mb-5" style={{maxHeight: "500px"}}>
                ...
                <div className="col-6 d-flex flex-column">
                    ...
                    <div>
                        <p style={{ maxWidth: "300px" }}>
                            Discover what makes us the preferred choice for IT solutions and integrations.
                            With us, it’s more than just technology—it’s about results that drive your success.
                        </p>
                    </div>
                    <div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-5 mt-5">
                            <div>
                                ...
                                <p className="m-0" style={{fontWeight:"700"}}>Powerful Technologies</p>
                            ...
                            <div className="mt-3">
                                ...
                                <p className="m-0" style={{fontWeight:"700"}}>Custom-Crafted Solutions</p>
                        ...
                        <div className="col-5">
                            <div>
                                ...
                                <p className="m-0" style={{fontWeight:"700"}}>Experienced Innovators</p>
                            ...
                            <div className="mt-3">
                                ...
                                <p className="m-0" style={{fontWeight:"700"}}>Reliability You Can Trust</p>
