...
import ee3070sdimention from "./AnprcameraIMG/anprdimension/ee3070s.jpeg";
    ...
    <div className="sdfsd">
      <div className="card2 ">
        <div className="card-body text-center">
          <div className="p-3">
            <h4 className="card-title mb-4 custom-left fw-semibold">EE3070S</h4>
            <div className="row  mb-5">
            <div className="col-md-4 col-12 ">
                <p className="leftside_top_text">Model</p>
                <p className="leftside_second_text">EE3070S</p>
              ...
              <div className="col-md-4 col-12 custom-right">
                ...
                <p className="rightside_second_text">HD</p>
              </div>
            </div>
    ...
    {isMobile ? (
      <>
        ...
        <div className="text-center">
          ...
          >
            <p>
            Houston's ANPR systems deliver precise vehicle access control, addressing challenges like varying lane configurations, high traffic density, lighting conditions, and plate diversity. Engineered for accuracy and adaptability, they ensure reliable performance even in demanding environments.
            </p>
          </div>
        </div>
      </>
