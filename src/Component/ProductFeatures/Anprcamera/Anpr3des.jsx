...
import Anprdimensions from "./AnprcameraIMG/Anprdimensions.jpg";
    ...
    <div className="sdfsd">
      <div className="card2 ">
        <div className="card-body text-center">
          <div className="p-3">
            <h4 className="card-title mb-4 custom-left fw-semibold">EE2070S</h4>
            <div className="row  mb-5">
            <div className="col-md-4 col-12 ">
                <p className="leftside_top_text">Model</p>
                <p className="leftside_second_text">EE2070M</p>
              ...
              <div className="col-md-4 col-12 custom-right">
                ...
                <p className="rightside_second_text"> 4K</p>
              </div>
            </div>
