...
import road2des from "./AXELIMG/TYRE K1100.png";
...
import Tyrek1100dimention from "./AXELIMG/Axlebreakerdimension/Tyrek1100.jpg";
...
import keyspecies3 from "./AXELIMG/key_species_1/keyspecies3.png";
import keyspecies4 from "./AXELIMG/key_species_1/key_species_5.png";
    ...
    <div className="sdfsd">
      <div className="card2 ">
        <div className="card-body text-center">
          <div className="p-3">
            <h1 className="card-title mb-4 custom-left">KETO K1100</h1>
            <div className="row  mb-5">
              <div className="col-md-4 col-12 ">
                <p className="leftside_top_text">Power Consumption</p>
                <p className="leftside_second_text">100W</p>
              ...
              <div className="col-md-4 col-12 custom-right">
                ...
                <p className="rightside_second_text">2-5 sec Customizable</p>
              </div>
            </div>
              ...
              <div className="row ">
                ...
                <div className="col-md-6 col-12 d-flex align-items-center">
                  <div className="row justify-content-around">
                    ...
                    Tyre killers are deployed in high-security zones like government facilities, banks, and prisons to disable unauthorized vehicles attempting forced entry.
                    </p>
                  </div>
                </div>
              </div>
