...
import Crb350dimention from "./AXELIMG/Axlebreakerdimension/Crb350.jpg";
        ...
        <div className="card-body text-center">
          <div className="p-3">
            ...
            <div className="col-md-4 col-12 ">
                ...
                <p className="leftside_second_text">420W</p>
              ...
              <div className="col-md-4 col-12  custom-image">
                <img src={road4} className="img-fluid" alt="VEGA" />
              </div>
              ...
              <div className="row ">
                ...
                <div className="col-md-6 col-12 d-flex align-items-center">
                  <div className="row justify-content-around">
                    ...
                    Crash-rated barriers are critical for securing high-risk locations like embassies, military zones, and nuclear power plants against vehicle-based threats.
                    </p>
                  </div>
                </div>
              </div>
