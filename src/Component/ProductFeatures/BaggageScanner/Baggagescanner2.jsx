          ...
          <Row className="text-center">
            <Col>
              ...
              <h6 className="fw-semibold" style={{ color: "#084D87", fontSize: "1.5rem" }}>
                Redefining Security Scanning Standards
              </h6>
            </Col>
          </Row>
            ...
            <>
              <div className="d-flex flex-column align-items-center mb-3">
                <div className="text-justify mb-3">
                  <p>
                    The HS6550 is engineered to deliver exceptional results with its solid build and expansive scanning tunnel, seamlessly
                    accommodating diverse baggage sizes. Its advanced X-ray imaging technology guarantees crystal-clear, high-resolution visuals for
                    accurate threat detection in critical scenarios.
                  </p>
                </div>
              </div>
