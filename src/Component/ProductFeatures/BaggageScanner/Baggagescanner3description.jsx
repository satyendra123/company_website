...
import bs6040dimention from "./BaggageScannerIMG/baggagescannerdimension/bs6040dimension.png";
...
const Baggagescanner3description = () => {
    ...
    <div className="sdfsd">
      <div className="card2 ">
        <div className="card-body text-center">
          <div className="p-3">
            <h4 className="card-title mb-4 custom-left fw-semibold">HS6040</h4>
            <div className="row  mb-5">
              <div className="col-md-4 col-12 ">
                ...
                <p className="leftside_second_text">600W*400H</p>
                <p className="leftside_top_text">Conveyor Load</p>
                <p className="leftside_second_text">170KG</p>
              </div>
...
export default Baggagescanner3description;
