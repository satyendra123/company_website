...
import Baggagescannes3 from "./BaggageScannerIMG/Baggage3.png";
import React, { useState, useRef, useEffect } from "react";

import bs5030dimention from "./BaggageScannerIMG/baggagescannerdimension/bs5030dimension.png";
...
const Baggagescanner4description = () => {
    ...
    <div className="sdfsd">
      <div className="card2 ">
        <div className="card-body text-center">
          <div className="p-3">
            <h4 className="card-title mb-4 custom-left fw-semibold">HS5030</h4>
            <div className="row  mb-5">
              <div className="col-md-4 col-12 ">
                ...
                <p className="leftside_second_text">500W*300H</p>
                <p className="leftside_top_text">Conveyor Load</p>
                <p className="leftside_second_text">130KG</p>
              </div>
              <div className="col-md-4 col-12  custom-image">
                <img src={Baggagescannes3} className="img-fluid" alt="VEGA" />
              </div>
              <div className="col-md-4 col-12 custom-right">
                ...
                <p className="rightside_second_text">30mm</p>
              </div>
            </div>
{/*start specs */}
    ...
    {isMobile ? (
      <>
        ...
        <div className="text-center">
          ...
          >
            <p>
              Houston's baggage scanners are designed with tunnel sizes ranging from 5030 to 100100,
              catering to diverse application requirements. Engineered for superior image clarity and
              reliability, they provide precise threat detection, ensuring seamless operation across
...
export default Baggagescanner4description;
