...
import shield1 from "./BollardImg/Shield.png";
...
import shielddimension from "./BollardImg/Bollarddimension/shielddimension.png"
    ...
    <div className="sdfsd">
      <div className="card2 ">
        <div className="card-body text-center">
          <div className="p-3">
            <h4 className="card-title mb-4 custom-left fw-semibold">Shield</h4>
            <div className="row  mb-5">
              <div className="col-md-4 col-12 ">
                <p className="leftside_top_text">Lifting Time</p>
                <p className="leftside_second_text">15cm/Sec</p>
                <p className="leftside_top_text">Breaking Resistance</p>
                <p className="leftside_second_text">4,00,000J</p>
                <p className="leftside_top_text">Impact Resistance</p>
                <p className="leftside_second_text">40,000J</p>
              </div>
              <div className="col-md-4 col-12  custom-image">
                <img src={shield1} className="img-fluid" alt="VEGA" />
              </div>
              <div className="col-md-4 col-12 custom-right">
                ...
                <p className="rightside_second_text">600 x 220 x 6 mm</p>
              </div>
            </div>
