...
import shield3 from "./BollardImg/Super Shield.png";
...
import shielplusdimension from "./BollardImg/Bollarddimension/shielplusdimension.png"
    ...
    <div className="sdfsd">
      <div className="card2 ">
        <div className="card-body text-center">
          <div className="p-3">
            <h4 className="card-title mb-4 custom-left fw-semibold">Super Shield</h4>
            <div className="row  mb-5">
            <div className="col-md-4 col-12 ">
                <p className="leftside_top_text">Lifting Time</p>
                <p className="leftside_second_text">18cm/Sec</p>
                <p className="leftside_top_text">Breaking Resistance</p>
                <p className="leftside_second_text">12,00,000J</p>
                <p className="leftside_top_text">Impact Resistance</p>
                <p className="leftside_second_text">80,000J</p>
              </div>
              <div className="col-md-4 col-12  custom-image">
                <img src={shield3} className="img-fluid" alt="VEGA" />
              </div>
              <div className="col-md-4 col-12 custom-right">
                ...
                <p className="rightside_second_text">800 x 275 x 12 mm</p>
              </div>
            </div>
...
<Container fluid className="py-4">
              ...
              <Row className="align-items-center">
                ...
                >
                  ...
                  >
                    <p>
                    The Bollard illustrates the installation design for a bollard,
                      with specific details on its dimensions and surrounding structure.
                      The bollard has a 325mm diameter and is designed with an exposed height of 600mm,
                      while its total embedded depth in the ground is 780mm.
                      The installation includes a stable gravel base with a drainage/permeable layer at the bottom,
                      ensuring proper water flow and stability.
                      The bollard is surrounded by 38mm of space and positioned within a pavement layer.
                    </p>
                  </div>
                </Col>
