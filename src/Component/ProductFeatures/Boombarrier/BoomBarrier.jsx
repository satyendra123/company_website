...
import BOOM_BARIER_2 from "./Boombarrier/BOOM-BARIER.gif";
const testimonials = [
  {
  ...
  return (
    <div className="product-feature-container">
      <div className="subfeature">
        <div className="leftsidecard md-4">
          <div className="row no-gutters">
            <div className="productpagetext-section">
              <h3>EVA</h3>
              <h4>Welcome to the Doorways to the Convenience</h4>
              <div className="card-logo">
                <p>
                  Designed to meet most common operational applications of
                  residential sliding gates. Suitable for a maximum weight up to
                  500 KG.
                </p>
              </div>
            </div>
            <div className="productpageimage-section">
              <div className="main-image">
                <img
                  src="/image/Product_images/group1000001891.png"
                  alt="Dispensor"
                />
              </div>
              <div className="vertical-images">
                <div className="image-with-text">
                  <img
                    src="/image/Product_images/maskgroup.png"
                    alt="Year Warranty"
                  />
                ...
                <div className="image-with-text">
                  <img src="/image/Product_images/maskgroup.png" alt="MCBF" />
                ...
                <div className="image-with-text">
                  <img
                    ...
                    alt="Duty Cycle"
                  />
                  <div className="overlay-text" style={{ fontSize: "12px" }}>
                    85%
                  </div>
        ...
        <div className="leftsidecard mt-5">
          <div className="row no-gutters">
            <div className="productpagetext-section">
              <h3>EVA</h3>
              <h4>Welcome to the Doorways to the Convenience</h4>
      ...
      <div className="card2 ">
        <div className="card-body text-center">
          <div className="p-3">
            <h1 className="card-title mb-4 custom-left">EVA</h1>
            <div className="row  mb-5">
              ...
              <div className="col-md-4 col-12  custom-image">
                <img src={BOOM_BARIER_2} className="img-fluid" alt="EVA" />
              </div>
            ...
            <div className="row  mb-4 mr-0">
              <div className="col-12 col-md-4 pl-3 mt- pr-0 d-flex flex-column">
                <div className="cardtexticon mb-3">
                  <img
