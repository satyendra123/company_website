...
import dfmd1des from "./DFMDIMG/DF2030S.png";
    ...
    <div className="sdfsd">
      <div className="card2 ">
        <div className="card-body text-center">
          <div className="p-3">
            <h4 className="card-title mb-4 custom-left fw-semibold">DF2030S</h4>
            <div className="row  mb-5">
              <div className="col-md-4 col-12 ">
                <p className="leftside_top_text">Zone</p>
                <p className="leftside_second_text">6</p>
                <p className="leftside_top_text">Visual Display</p>
                <p className="leftside_second_text">5 digit led display</p>
              ...
              <div className="col-md-4 col-12  custom-image">
                <img src={dfmd1des} className="img-fluid" alt="VEGA" />
              </div>
              <div className="col-md-4 col-12 custom-right">
                <p className="rightside_top_text">Frequency</p>
                <p className="rightside_second_text">5.9K-8.6KHz</p>
