...
import dfmd2des from "./DFMDIMG/DF2010S.png";
...
import dfmd4 from './DFMDIMG/Midea/DFMD3.png'
    ...
    <div className="sdfsd">
      <div className="card2 ">
        <div className="card-body text-center">
          <div className="p-3">
            <h4 className="card-title mb-4 custom-left fw-semibold">DF2010S</h4>
            <div className="row  mb-5">
            <div className="col-md-4 col-12 ">
                <p className="leftside_top_text">Zone</p>
                <p className="leftside_second_text">18</p>
                <p className="leftside_top_text">Visual Display</p>
                <p className="leftside_second_text">digital tube display</p>
                <p className="leftside_top_text">Sensitivity</p>
                <p className="leftside_second_text">0-99</p>
              </div>
              <div className="col-md-4 col-12  custom-image">
                <img src={dfmd2des} className="img-fluid" alt="VEGA" />
              </div>
              <div className="col-md-4 col-12 custom-right">
                ...
                <p className="rightside_second_text">50-120/Min</p>
                <p className="rightside_top_text">Power Consumption</p>
                <p className="rightside_second_text">20W</p>
              </div>
            </div>
