...
import dfmddes3 from "./DFMDIMG/DF3350M.png";
    ...
    <div className="sdfsd">
      <div className="card2 ">
        <div className="card-body text-center">
          <div className="p-3">
            <h4 className="card-title mb-4 custom-left fw-semibold">DF3350M</h4>
            <div className="row  mb-5">
            <div className="col-md-4 col-12 ">
                <p className="leftside_top_text">Zone</p>
                <p className="leftside_second_text">24</p>
                <p className="leftside_top_text">Visual Display</p>
                <p className="leftside_second_text">7 inch & digital tube display</p>
                <p className="leftside_top_text">Sensitivity</p>
                <p className="leftside_second_text">0-299</p>
              </div>
              <div className="col-md-4 col-12  custom-image">
                <img src={dfmddes3} className="img-fluid" alt="VEGA" />
              </div>
