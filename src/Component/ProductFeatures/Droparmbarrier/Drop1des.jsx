...
import road1des from "./DROPARMIMG/P-TYPE P200.png";
import React, { useState,useRef, useEffect } from "react";
import { Container, Row, Col, Form, Button } from "react-bootstrap";
import Parkinglots from "./DROPARMIMG/Parkinglots.png";
import Embasies from "./DROPARMIMG/Embasies.png";
import Toll from "./DROPARMIMG/Toll.png";
import Factory from "./DROPARMIMG/Factory.png";
import qr from "./DROPARMIMG/qr.png";

import drop1 from "./DROPARMIMG/midea/Drop Arm 1.png";
import drop2 from "./DROPARMIMG/midea/Drop Arm 2.png";
import drop3 from "./DROPARMIMG/midea/Drop Arm 3.png";
import drop4 from "./DROPARMIMG/midea/Drop Arm 4.png";

import p200 from "./DROPARMIMG/droparmintegration/P200.png";
import p200dimension from "./DROPARMIMG/droparmdimension/p200dimension.png";

import keyspecies1 from './DROPARMIMG/key_species/Keyspecies_1.png'
import keyspecies2 from './DROPARMIMG/key_species/Keyspecies_2.png'
import keyspecies3 from './DROPARMIMG/key_species/Keyspecies_3.png'
import keyspecies4 from './DROPARMIMG/key_species/Keyspecies_4.png'
    ...
    <div className="sdfsd">
      <div className="card2 ">
        <div className="card-body text-center">
          <div className="p-3">
            <h4 className="card-title mb-4 custom-left fw-semibold">P-type 200</h4>
            <div className="row  mb-5">
              ...
              <div className="col-md-4 col-12  custom-image">
                <img src={road1des} className="img-fluid" alt="VEGA" />
              </div>
              <div className="col-md-4 col-12 custom-right">
                ...
                <p className="rightside_second_text">250 * 180 * 980</p>
              </div>
            </div>
