...
import roaddes3 from "./DROPARMIMG/DROPARM D50.png";
    ...
    <div className="sdfsd">
      <div className="card2 ">
        <div className="card-body text-center">
          <div className="p-3">
            <h1 className="card-title mb-4 custom-left">Droparm D50</h1>
            ...
            <div className="col-md-4 col-12 ">
              ...
              <div className="col-md-4 col-12  custom-image">
                <img src={roaddes3} className="img-fluid" alt="VEGA" />
              </div>
