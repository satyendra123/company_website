...
import axeldes4 from "./DROPARMIMG/DROPARM D80.png";
    ...
    <div className="sdfsd">
      <div className="card2 ">
        <div className="card-body text-center">
          <div className="p-3">
            <h1 className="card-title mb-4 custom-left">Droparm D80</h1>
            ...
            <div className="col-md-4 col-12 ">
              ...
              <div className="col-md-4 col-12  custom-image">
                <img src={axeldes4} className="img-fluid" alt="VEGA" />
              </div>
