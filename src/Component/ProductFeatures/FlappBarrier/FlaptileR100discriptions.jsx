  ...
  {isMobile ? (
    <div className="mobile-layout">
      ...
      <div className="description mt-3">
        <p>
          Houston's flap barrier's are designed with different dimensions, and aesthetics play an important role in deciding lane configurations based on the site layout. These systems ensure seamless functionality, durability, and adaptability to high-traffic environments.
        </p>
      </div>
    </div>
  ) : (
    ...
    {isMobile ? (
      <>
        ...
        <div className="text-center">
          ...
          >
            <p>
              Houston's flap barrier's are designed with different dimensions and aesthetics play an important role to decide lane configurations as per site layout. These systems ensure seamless functionality, durability, and adaptability to high-traffic environments.
            </p>
          </div>
        </div>
      </>
