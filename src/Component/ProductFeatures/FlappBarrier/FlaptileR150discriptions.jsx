...
import FlaptileR150 from "./FlappbarrierIMG/flappbarrier150.png";
import React, { useState,useRef, useEffect } from "react";


import { Container, Row, Col, Form, Button } from "react-bootstrap";
import r150dimention from "./FlappbarrierIMG/flapdimension/r150dimention.png";
...
import Flaptiler150 from "./FlappbarrierIMG/flapbarrierintegration/Flaptiler150.png";
...
const FlaptileR150discriptions = () => {
    ...
    <div className="sdfsd">
      <div className="card2 ">
        <div className="card-body text-center">
          <div className="p-3">
            <h4 className="card-title mb-4 custom-left fw-semibold">Flaptile R150</h4>
            ...
            <div className="col-md-4 col-12 ">
              ...
              <div className="col-md-4 col-12  custom-image">
                <img src={FlaptileR150} className="img-fluid" alt="VEGA" />
              </div>
              <div className="col-md-4 col-12 custom-right">
                ...
                <p className="rightside_second_text">1410 x 300 x 980</p>
              </div>
            </div>
  ...
  {isMobile ? (
    <div className="mobile-layout">
      ...
      <div className="description mt-3">
        <p>
          Houston's flap barrier's are designed with different dimensions, and aesthetics play an important role in deciding lane configurations as per the site layout. These systems ensure seamless functionality, durability, and adaptability to high-traffic environments.
        </p>
      </div>
    </div>
  ) : (
        ...
        <div className="text-center">
          ...
          >
            <p>
              ...
              dimensions and aesthetics play an important role to decide
              lane configurations as per site layout. These systems ensure
              seamless functionality, durability, and adaptability to
...
export default FlaptileR150discriptions;
