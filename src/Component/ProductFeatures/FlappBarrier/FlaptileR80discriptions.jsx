...
import FlaptileR180 from "./FlappbarrierIMG/Fliptiler80.png";
import React, { useState, useRef, useEffect } from "react";
import r80dimention from "./FlappbarrierIMG/flapdimension/r80dimention.png";
...
import Flaptiler80 from "./FlappbarrierIMG/flapbarrierintegration/Flaptiler80.png";
    ...
    <div className="sdfsd">
      <div className="card2 ">
        <div className="card-body text-center">
          <div className="p-3">
            <h4 className="card-title mb-4 custom-left fw-semibold">Flaptile R80</h4>
            ...
            <div className="col-md-4 col-12 ">
              ...
              <div className="col-md-4 col-12 custom-right">
                ...
                <p className="rightside_second_text">600 x 250 x 980</p>
              </div>
            </div>
  ...
  {isMobile ? (
    <div className="mobile-layout">
      ...
      <div className="description mt-3">
        <p>
          Flap barriers are used in metro stations, corporate offices, and stadiums for effective pedestrian management and access control, integrating seamlessly with ticketing and RFID systems.
        </p>
      </div>
    </div>
  ) : (
        ...
        <div className="text-center">
          ...
          >
            <p className="text-justify">
              Houston's flap barrier's are designed with different dimensions and aesthetics that play an important role in deciding lane configurations as per site layout. These systems ensure seamless functionality, durability, and adaptability to high-traffic environments.
            </p>
          </div>
        </div>
      </>
...
export default FlaptileR80discriptions;
