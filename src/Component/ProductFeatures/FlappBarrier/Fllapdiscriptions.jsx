...
import FlaptileR180 from "./FlappbarrierIMG/Fliptiler180.png";
...
import r180dimention from "./FlappbarrierIMG/flapdimension/r180dimention.png";
...
import Flaptiler180 from "./FlappbarrierIMG/flapbarrierintegration/Flaptiler180.png";
    ...
    <div className="sdfsd">
      <div className="card2 ">
        <div className="card-body text-center">
          <div className="p-3">
            <h4 className="card-title mb-4 custom-left fw-semibold">Flaptile R180</h4>
            ...
            <div className="col-md-4 col-12 ">
              ...
              <div className="col-md-4 col-12  custom-image">
                <img src={FlaptileR180} className="img-fluid" alt="VEGA" />
              </div>
  ...
  {isMobile ? (
    <div className="mobile-layout">
      ...
      <div className="description mt-3">
        <p>
          Houston's flap barriers are designed with different dimensions, and aesthetics play an important role in deciding lane configurations based on the site layout. These systems ensure seamless functionality, durability, and adaptability to high-traffic environments.
        </p>
      </div>
    </div>
  ) : (
...
export default Fllapdiscriptions;
