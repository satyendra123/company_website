...
import des1 from "./FullheigtturnstileImg/FULL HEIGHT 1100.png";
...
import fh1100dimension from "./FullheigtturnstileImg/fhturnstiledimension/fh1100turnstile.png";
import fhintegration1100 from "./FullheigtturnstileImg/fhturnstileintegration/fhintegration1100.png";
    ...
    <div className="sdfsd">
      <div className="card2 ">
        <div className="card-body text-center">
          <div className="p-3">
            <h4 className="card-title mb-4 custom-left fw-semibold">Full height 1100</h4>
            <div className="row  mb-5">
              <div className="col-md-4 col-12 ">
                <p className="leftside_top_text">Material</p>
                <p className="leftside_second_text">SS304</p>
                <p className="leftside_top_text">Opening Speed</p>
                <p className="leftside_second_text">0.2 sec</p>
              ...
              <div className="col-md-4 col-12  custom-image">
                <img src={des1} className="img-fluid" alt="VEGA" />
              </div>
              <div className="col-md-4 col-12 custom-right">
                ...
                <p className="rightside_second_text">1600 x 1500 x 2300</p>
              </div>
            </div>
