...
import des2 from "./FullheigtturnstileImg/FULL HEIGHT 2200.png";
...
import fh2200dimension from "./FullheigtturnstileImg/fhturnstiledimension/fh2200turnstile.png";
import fhintegration2200 from "./FullheigtturnstileImg/fhturnstileintegration/fhintegration2200.png";
    ...
    <div className="sdfsd">
      <div className="card2 ">
        <div className="card-body text-center">
          <div className="p-3">
            <h4 className="card-title mb-4 custom-left fw-semibold">Full height 2200</h4>
            ...
            <div className="col-md-4 col-12 ">
                ...
                <p className="leftside_second_text">0.1 sec</p>
              ...
              <div className="col-md-4 col-12  custom-image">
                <img src={des2} className="img-fluid" alt="VEGA" />
              </div>
              <div className="col-md-4 col-12 custom-right">
                ...
                <p className="rightside_second_text">2400 x 1350 x 2300</p>
              </div>
            </div>
