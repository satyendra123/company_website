...
import full3des from "./FullheigtturnstileImg/FULL HEIGHT 1100.png";
import Full_height from "./FullheigtturnstileImg/fullheight.jpg";
import React, { useState, useRef, useEffect } from "react";
import { Container, Row, Col, Form, Button } from "react-bootstrap";
import a_park from "./FullheigtturnstileImg/a_park.png";
import sports_ from "./FullheigtturnstileImg/sports_.png";
import entertainment_ from "./FullheigtturnstileImg/entertainment_.png";
import Government_buildings from "./FullheigtturnstileImg/Government_buildings.png";
import qr from "./FullheigtturnstileImg/qr.png";

import gallary1 from "./FullheigtturnstileImg/media/g1.png";
import gallary2 from "./FullheigtturnstileImg/media/g2.png";
import gallary3 from "./FullheigtturnstileImg/media/g3.png";
import gallary4 from "./FullheigtturnstileImg/media/g4.png";
...
import fh1000dimension from "./FullheigtturnstileImg/fhturnstiledimension/fh1000turnstile.png";
import fhintegration1000 from "./FullheigtturnstileImg/fhturnstileintegration/fhintegration1000.png";
import keyspecies1 from './FullheigtturnstileImg/key_species/Keyspecies_1.png'
import keyspecies2 from './FullheigtturnstileImg/key_species/Keyspecies_2.png'
import keyspecies3 from './FullheigtturnstileImg/key_species/Keyspecies_3.png'
import keyspecies4 from './FullheigtturnstileImg/key_species/Keyspecies_4.png'
    ...
    <div className="sdfsd">
      <div className="card2 ">
        <div className="card-body text-center">
          <div className="p-3">
            <h4 className="card-title mb-4 custom-left fw-semibold">Full height 1000</h4>
            <div className="row  mb-5">
            <div className="col-md-4 col-12 ">
                <p className="leftside_top_text">Material</p>
                <p className="leftside_second_text">SS304</p>
                <p className="leftside_top_text">MCBF</p>
                <p className="leftside_second_text">10 Million</p>
                <p className="leftside_top_text">Direction</p>
                <p className="leftside_second_text">Bi-Direction</p>
              </div>
              <div className="col-md-4 col-12  custom-image">
                <img src={full3des} className="img-fluid" alt="VEGA" />
              </div>
              <div className="col-md-4 col-12 custom-right">
                <p className="rightside_top_text">Pass Width</p>
                <p className="rightside_second_text">650mm</p>
                <p className="rightside_top_text">IP Rating</p>
                <p className="rightside_second_text">IP55</p>
                <p className="rightside_top_text">DIMENSION</p>
                <p className="rightside_second_text">1450 x 1200 x 2180</p>
              </div>
            </div>
              ...
              <div className="row ">
                ...
                <div className="col-md-6 col-12 d-flex align-items-center">
                  <div className="row justify-content-around">
                    ...
                    Full-height turnstiles are installed in secure zones like stadiums, construction sites, and industrial areas to prevent unauthorized access.
    ...
    {isMobile ? (
      <>
        ...
        <div className="text-center">
          ...
          >
            <p>
              Houston's full-height turnstiles are built for robust security and efficient pedestrian
              control, designed to accommodate site-specific factors such as area layout, footfall, and
              dimensions. These turnstiles ensure seamless integration into the environment, providing
              reliable access management and enhanced security for high-traffic areas.
            </p>
          </div>
        </div>
      </>
