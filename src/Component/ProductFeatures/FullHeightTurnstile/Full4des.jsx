...
import fh2000dimension from "./FullheigtturnstileImg/fhturnstiledimension/fh2000turnstile.png";
import fhintegration2000 from "./FullheigtturnstileImg/fhturnstileintegration/fhintegration2000.png";
    ...
    <div className="sdfsd">
      <div className="card2 ">
        <div className="card-body text-center">
          <div className="p-3">
            <h4 className="card-title mb-4 custom-left fw-semibold">Full height 2000</h4>
            ...
            <div className="col-md-4 col-12 ">
              ...
              <div className="col-md-4 col-12  custom-image">
                <img src={full4} className="img-fluid" alt="VEGA" />
              </div>
              <div className="col-md-4 col-12 custom-right">
                ...
                <p className="rightside_second_text">2200 x 1450 x 2300</p>
              </div>
            </div>
