...
import parki from "./ProductsubfeauresIMG/BOOM-BARIER.gif";
...
import parkidimension from "./ProductsubfeauresIMG/Productfeaturesdimension/parki.png";
    ...
    <div className="sdfsd">
      <div className="card2 ">
        <div className="card-body text-center">
          <div className="p-3">
            <h4 className="card-title mb-4 custom-left fw-semibold">Parki Series</h4>
            ...
            <div className="col-md-4 col-12 ">
              ...
              <div className="col-md-4 col-12  custom-image">
                <img src={parki} className="img-fluid" alt="VEGA" />
              </div>
              <div className="col-md-4 col-12 custom-right">
                ...
                <p className="rightside_second_text">2 Sec</p>
...
export default Parkidiscription;
