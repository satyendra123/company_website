...
import tornadodimension from "./ProductsubfeauresIMG/Productfeaturesdimension/tornado.png";
...
import keyspecies4 from "./ProductsubfeauresIMG/key_species_1/keyspecies4.png";
    ...
    <div className="sdfsd">
      <div className="card2 ">
        <div className="card-body text-center">
          <div className="p-3">
            <h4 className="card-title mb-4 custom-left text-capitalize fw-semibold">Tornado Series</h4>
            ...
            <div className="col-md-4 col-12 ">
              ...
              <div className="col-md-4 col-12 custom-right">
                ...
                <p className="rightside_second_text">0.8 Sec</p>
...
export default Tornadodiscription;
