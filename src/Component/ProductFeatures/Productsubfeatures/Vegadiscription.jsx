...
import BOOM_BARIER_2 from "./ProductsubfeauresIMG/Vegagif.gif";
...
import Toll from "./ProductsubfeauresIMG/Toll.png";
import qr from "./ProductsubfeauresIMG/qr.png";
import vegadimension from "./ProductsubfeauresIMG/Productfeaturesdimension/vega.png";

import keyspecies from "./ProductsubfeauresIMG/key_species_1/key_species_1.png";
import keyspecies2 from "./ProductsubfeauresIMG/key_species_1/Keyspecies_2.png";
import keyspecies3 from "./ProductsubfeauresIMG/key_species_1/keyspecies3.png";
import keyspecies4 from "./ProductsubfeauresIMG/key_species_1/key_species_5.png";

import image1 from "./ProductsubfeauresIMG/mediaimage/image1.png";
import image2 from "./ProductsubfeauresIMG/mediaimage/image2.png";
import image3 from "./ProductsubfeauresIMG/mediaimage/image3.png";
import image4 from "./ProductsubfeauresIMG/mediaimage/image1.png";
    ...
    <div className="sdfsd">
      <div className="card2 ">
        <div className="card-body text-center">
          <div className="p-3">
            <h4 className="card-title mb-4 custom-left text-capitalize fw-semibold">Vega Series</h4>
            <div className="row  mb-5">
              <div className="col-md-4 col-12 ">
                <p className="leftside_top_text">Power Supply</p>
                <p className="leftside_second_text">80 Watt</p>
                <p className="leftside_top_text">Arm Length</p>
                <p className="leftside_second_text">6 Meter</p>
                <p className="leftside_top_text">Standard Color</p>
                <p className="leftside_second_text">RAL 7001</p>
              </div>
              ...
              <div className="col-md-4 col-12 custom-right">
                ...
                <p className="rightside_second_text">4 Sec</p>
                <p className="rightside_top_text">MCBF</p>
                <p className="rightside_second_text">10 Million</p>
              </div>
            </div>
  ...
  {isMobile ? (
    ...
    <>
      <div className="col-12 col-md-2">
        <p className="key-specs-text text-center text-md-start">KEY SPECS.</p>
      </div>
      ...
      <div className="col-12 col-md">
        <div className="row justify-content-start g-3">
          {/* Desktop layout (Grid for images) */}
...
<Container>
      ...
      <Row className="align-items-center">
        <h4 className="text-center fw-bold">Dimensions and Layouts</h4>
        {isMobile ? (
          <>
            {/* Image First */}
            ...
            <div  className="text-center">
              ...
              >
                <p className="text-justify">
                  Houston's boom barriers offer versatile solutions with
                  telescopic, articulated, fence, and folding arms to suit
                  various site layouts and access needs, ensuring efficient and
...
export default Vegadiscription;