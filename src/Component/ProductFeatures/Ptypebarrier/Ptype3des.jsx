...
import roaddes3 from "./PTYPEIMG/DROPARM D50.png";
...
import d50dimension from "./PTYPEIMG/Ptypedimension/d50dimension.png";
import d50integration from "./PTYPEIMG/Ptypeintegration/d50integration.png";
          ...
          <div className="p-3">
            ...
            <div className="col-md-4 col-12 ">
              ...
              <p className="rightside_second_text">0.2S</p>
                ...
                <p className="rightside_second_text">1200 * 165 * 980</p>
              ...
              <div className="row ">
                ...
                <div className="col-md-6 col-12 d-flex align-items-center">
                  <div className="row justify-content-around">
                    ...
                    Drop arm barriers are ideal for toll plazas, parking garages, and restricted zones, providing quick and reliable vehicle access control.
