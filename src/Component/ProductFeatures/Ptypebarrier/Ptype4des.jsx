...
import axeldes4 from "./PTYPEIMG/DROPARM D80.png";
    ...
    <div className="sdfsd">
      <div className="card2 ">
        <div className="card-body text-center">
          <div className="p-3">
            <h4 className="card-title mb-4 custom-left fw-semibold">Droparm D80</h4>
            ...
            <div className="col-md-4 col-12 ">
              ...
              <p className="rightside_second_text">0.3S</p>
                ...
                <p className="rightside_second_text">1250 * 180 * 980</p>
              </div>
            </div>
