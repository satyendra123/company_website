...
import road2des from "./ROADIMG/TYRE K1100.png";
...
import Tyrek1100dimention from "./ROADIMG/Roadblockdimension/Tyrek1100.jpg";
...
import keyspecies4 from "./ROADIMG/key_species_1/key_species_5.png";
    ...
    <div className="sdfsd">
      <div className="card2 ">
        <div className="card-body text-center">
          <div className="p-3">
            <h4 className="card-title mb-4 custom-left fw-semibold">KETO K1100</h4>
