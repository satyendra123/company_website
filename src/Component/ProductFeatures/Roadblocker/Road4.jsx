...
import road4 from "./ROADIMG/Roacker B380.png";
import "./Road.css";
            ...
            <>
              <div className="d-flex flex-column align-items-center mb-3">
                <div className="text-justify mb-3">
                  <p>
                    Precision-crafted to provide unmatched anti-terrorist protection, the CRB350 delivers robust defense, ensuring the highest level of security for critical assets and environments. 
                    Its advanced design offers peace of mind and dependable performance in high-risk zones.
                  </p>
                </div>
              </div>
