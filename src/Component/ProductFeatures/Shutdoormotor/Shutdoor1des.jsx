...
import shut_des1 from "../Shutdoormotor/ShutdoormotorIMG/Shutdooricons/shutdesh1.png";
    ...
    <div className="sdfsd">
      <div className="card2 ">
        <div className="card-body text-center">
          <div className="p-3">
            <h4 className="card-title mb-4 custom-left fw-semibold">Roller H200</h4>
            <div className="row  mb-5">
              ...
              <div className="col-md-4 col-12  custom-image">
                <img src={rollerh200} className="img-fluid" alt="VEGA" />
              </div>
...
<div className="row align-items-center">
  {isMobile ? (
    ...
    <div className="row mb-3">
      ...
      {[keyspecies1, keyspecies2, keyspecies3, keyspecies4].map((src, index) => (
