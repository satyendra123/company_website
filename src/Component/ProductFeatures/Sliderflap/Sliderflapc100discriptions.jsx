...
import r100dimension from "./SliderflapIMG/Sliderflapdimension/c100dimension.png";

import { Container, Row, Col, Form, Button } from "react-bootstrap";

import Turnerc100 from "./SliderflapIMG/Sliderflapintegration/TurnerC100.png";
...
const Sliderflapc100discriptions = () => {
    ...
    <div className="sdfsd">
      <div className="card2 ">
        <div className="card-body text-center">
          <div className="p-3">
            <h4 className="card-title mb-4 custom-left fw-semibold">Flaptile SL1310</h4>
            ...
            <div className="col-md-4 col-12 ">
              ...
              <div className="col-md-4 col-12 custom-right">
                ...
                <p className="rightside_second_text">1400 x 250 x 1000</p>
              </div>
            </div>
...
export default Sliderflapc100discriptions;
