...
import teva from "./SlidinggateoperatorIMG/Teva.png";
    ...
    <div className="sdfsd">
      <div className="card2 ">
        <div className="card-body text-center">
          <div className="p-3">
            <h4 className="card-title mb-4 custom-left fw-semibold">Teva</h4>
            ...
            <div className="col-md-4 col-12 ">
              ...
              <div className="col-md-4 col-12 custom-right">
                ...
                <p className="rightside_second_text"> 670 N</p>
              </div>
            </div>
