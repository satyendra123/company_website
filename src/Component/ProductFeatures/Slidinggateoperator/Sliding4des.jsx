...
import turbo from "./SlidinggateoperatorIMG/turbo.png";
...
import gallary1 from "./SlidinggateoperatorIMG/media/g1.png";
import gallary2 from "./SlidinggateoperatorIMG/media/g2.png";
import gallary3 from "./SlidinggateoperatorIMG/media/g3.png";
import gallary4 from "./SlidinggateoperatorIMG/media/g4.png";
    ...
    <div className="sdfsd">
      <div className="card2 ">
        <div className="card-body text-center">
          <div className="p-3">
            <h4 className="card-title mb-4 custom-left fw-semibold">Turbo</h4>
            ...
            <div className="col-md-4 col-12 ">
                ...
                <p className="leftside_second_text">15 Meter</p>
                <p className="leftside_top_text">Duty Cycle</p>
                <p className="leftside_second_text">90%</p>
              </div>
              <div className="col-md-4 col-12  custom-image">
                <img src={turbo} className="img-fluid" alt="VEGA" />
              </div>
              <div className="col-md-4 col-12 custom-right">
                <p className="rightside_top_text">Capacity</p>
                <p className="rightside_second_text"> 4000KG</p>
                <p className="rightside_top_text">Opening Speed</p>
                <p className="rightside_second_text"> 9 Meter/Min</p>
                <p className="rightside_top_text">Thrust</p>
                <p className="rightside_second_text"> 4800 N</p>
              </div>
            </div>
