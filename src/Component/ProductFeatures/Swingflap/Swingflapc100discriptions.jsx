...
import r100dimension from "./SWINGFLAPIMG/swingflapdimension/c100dimension.png";

import { Container, Row, Col, Form, Button } from "react-bootstrap";

import Turnerc100 from "./SWINGFLAPIMG/swingflapintegration/TurnerC100.png";
...
const Swingbarrierc100discriptions = () => {
    ...
    <div className="sdfsd">
      <div className="card2 ">
        <div className="card-body text-center">
          <div className="p-3">
            <h4 className="card-title mb-4 custom-left fw-semibold">Flaptile SW1080 </h4>
            ...
            <div className="col-md-4 col-12 ">
              ...
              <div className="col-md-4 col-12 custom-right">
                ...
                <p className="rightside_second_text">1400 x 250 x 980</p>
              </div>
            </div>
...
<div className="row align-items-center">
  {isMobile ? (
    ...
    <>
      <div className="col-2">
        <p className="key-specs-text">ANOTHER SPECS.</p>
      </div>
      <div className="col-1">
...
export default Swingbarrierc100discriptions;
