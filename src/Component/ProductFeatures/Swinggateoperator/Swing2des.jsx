...
import swingo from "./swinggateoperatorIMG/swingo.png";
...
import swingodimensions from "./swinggateoperatorIMG/Swinggatedimension/swingodimension.jpg";
    ...
    <div className="sdfsd">
      <div className="card2 ">
        <div className="card-body text-center">
          <div className="p-3">
            <h4 className="card-title mb-4 custom-left fw-semibold">Swingo</h4>
            ...
            <div className="col-md-4 col-12 ">
              ...
              <div className="col-md-4 col-12  custom-image">
                <img src={swingo} className="img-fluid" alt="VEGA" />
              </div>
              <div className="col-md-4 col-12 custom-right">
                <p className="rightside_top_text">Capacity</p>
                <p className="rightside_second_text"> 400KG</p>
                <p className="rightside_top_text">Opening Time</p>
                <p className="rightside_second_text">7-12 sec</p>
                <p className="rightside_top_text">Thrust</p>
                <p className="rightside_second_text"> 1800 N</p>
              </div>
            </div>
