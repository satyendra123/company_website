...
import olio from "./swinggateoperatorIMG/Olio.png";
...
import oleodimensions from "./swinggateoperatorIMG/Swinggatedimension/oleodimension.jpg";
    ...
    <div className="sdfsd">
      <div className="card2 ">
        <div className="card-body text-center">
          <div className="p-3">
            <h4 className="card-title mb-4 custom-left fw-semibold">Oleo</h4>
            ...
            <div className="col-md-4 col-12 ">
                ...
                <p className="leftside_second_text">2.5 Meter</p>
              ...
              <div className="col-md-4 col-12  custom-image">
                <img src={olio} className="img-fluid" alt="VEGA" />
              </div>
              <div className="col-md-4 col-12 custom-right">
                <p className="rightside_top_text">Capacity</p>
                <p className="rightside_second_text"> 300KG</p>
                <p className="rightside_top_text">Opening Time</p>
                <p className="rightside_second_text">5-8 sec</p>
                <p className="rightside_top_text">Thrust</p>
                <p className="rightside_second_text"> 3000 N</p>
              </div>
            </div>
