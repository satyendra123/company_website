...
import r100dimension from "./TRIPODEIMG/tripoddimension/c100dimension.png";
...
import Turnerc100 from "./TRIPODEIMG/Tripodtwointegration/TurnerC100.png";
    ...
    <div className="sdfsd">
      <div className="card2 ">
        <div className="card-body text-center">
          <div className="p-3">
            <h4 className="card-title mb-4 custom-left fw-semibold">Turner C100 </h4>
            ...
            <div className="col-md-4 col-12 ">
              ...
              <div className="col-md-4 col-12  custom-image">
                <img src={turnerc100} className="img-fluid" alt="VEGA" />
              </div>
              <div className="col-md-4 col-12 custom-right">
                ...
                <p className="rightside_second_text">0.1S</p>
                <p className="rightside_top_text">Dimension</p>
                <p className="rightside_second_text">360 x 260 x 980</p>
              </div>
            </div>
...
export default Turnerc100discriptions;
