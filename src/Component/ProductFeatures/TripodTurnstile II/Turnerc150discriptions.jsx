...
import Turnerdf150 from "./TRIPODEIMG/turnerc150.png";
import React, { useState,useRef, useEffect } from "react";
import { Container, Row, Col, Form, Button } from "react-bootstrap";
import Turnercintegration150 from "./TRIPODEIMG/Tripodtwointegration/TurnerC150.png";
import r150dimension from "./TRIPODEIMG/tripoddimension/c150dimension.png";
    ...
    <div className="sdfsd">
      <div className="card2 ">
        <div className="card-body text-center">
          <div className="p-3">
            <h4 className="card-title mb-4 custom-left fw-semibold">Turner C150 </h4>
            ...
            <div className="col-md-4 col-12 ">
              ...
              <div className="col-md-4 col-12 custom-right">
                ...
                <p className="rightside_second_text">HDMT</p>
                <p className="rightside_top_text">Opening Speed</p>
                <p className="rightside_second_text">0.25S</p>
                <p className="rightside_top_text">Dimension</p>
                <p className="rightside_second_text">480 x 280 x 980</p>
              </div>
            </div>
      ...
      <>
        ...
        <Col xs={12} md={6} className="text-center">
          ...
          />
            ...
            <Container>
              <h2 className="text-center mb-4 fw-semibold">Get in Touch</h2>
              <Form>
                <Row>
                  <Col xs={12} md={6}>
