...
import r200dimension from "./TRIPODEIMG/tripoddimension/c200dimension.png";

import Turnerc200 from "./TRIPODEIMG/Tripodtwointegration/TurnerC200.png";
          ...
          <div className="p-3">
            ...
            <div className="col-md-4 col-12 ">
              ...
              <div className="col-md-4 col-12 custom-right">
                ...
                <p className="rightside_second_text">220 x 330 x 980</p>
              </div>
            </div>
