...
import turnerec250 from "./TRIPODEIMG/Turnerc250.png";
import React, { useState,useRef, useEffect } from "react";

import { Container, Row, Col, Form, Button } from "react-bootstrap";

import r250dimension from "./TRIPODEIMG/tripoddimension/c250dimension.png";

import Turnerc250 from "./TRIPODEIMG/Tripodtwointegration/TurnerC250.png";

import a_park from "./TRIPODEIMG/a_park.png";
import sports_ from "./TRIPODEIMG/sports_.png";
import entertainment_ from "./TRIPODEIMG/entertainment_.png";
import Government_buildings from "./TRIPODEIMG/Government_buildings.png";
import qr from "./TRIPODEIMG/qr.png";

import keyspecies1 from './TRIPODEIMG/key_species/Keyspecies_1.png'
import keyspecies2 from './TRIPODEIMG/key_species/Keyspecies_2.png'
import keyspecies3 from './TRIPODEIMG/key_species/Keyspecies_3.png'
import keyspecies4 from './TRIPODEIMG/key_species/Keyspecies_4.png'
import image1 from "./TRIPODEIMG/Midea/t1.jpg";
import image2 from "./TRIPODEIMG/Midea/t2.jpg";
import image3 from "./TRIPODEIMG/Midea/t3.jpg";
import image4 from "./TRIPODEIMG/Midea/t4.jpg";
    ...
    <div className="sdfsd">
      <div className="card2 ">
        <div className="card-body text-center">
          <div className="p-3">
            <h4 className="card-title mb-4 custom-left fw-semibold">Turner C250 </h4>
            ...
            <div className="col-md-4 col-12 ">
                ...
                <p className="leftside_second_text">500 mm</p>
                <p className="leftside_top_text">Turning angle</p>
                <p className="leftside_second_text">120&deg;</p>
              </div>
              <div className="col-md-4 col-12  custom-image">
                <img src={turnerec250} className="img-fluid" alt="VEGA" />
              </div>
              <div className="col-md-4 col-12 custom-right">
                ...
                <p className="rightside_second_text">600 x 130 x 980</p>
              </div>
            </div>
    ...
    <div className="row align-items-center">
      ...
      <div className="col">
        <div className="row justify-content-start g-3">
          {[keyspecies1, keyspecies2, keyspecies3, keyspecies4].map((imgSrc, index) => (
            <div
    ...
    <div className="mobile-layout">
      ...
      <div className="row justify-content-center align-items-center">
        <div className="col-12 mb-3">
          <img src={a_park} className="img-fluid" alt="Park Icon" />
        </div>
        <div className="col-12 mb-3">
          <img src={sports_} className="img-fluid" alt="Sports Icon" />
        </div>
      </div>
      <div className="row justify-content-center align-items-center">
        <div className="col-12 mb-3">
          <img src={entertainment_} className="img-fluid" alt="Entertainment Icon" />
        </div>
        <div className="col-12 mb-3">
          <img src={Government_buildings} className="img-fluid" alt="Government Building Icon" />
        </div>
      </div>
    ...
    {isMobile ? (
      <>
        ...
        <div className="text-center">
          ...
          >
            <p>
              Houston's tripod turnstile systems are designed to provide efficient access control,
              with model selection based on key factors such as the number of entry and exit lanes,
              dimensions, and footfall. These systems ensure seamless functionality, durability,
              and adaptability to high-traffic environments.
            </p>
          </div>
        </div>
      </>
        ...
        <Col xs={12} md={6} className="text-center">
          ...
          />
            ...
            <div className="Application">
              <h4 className="card-title mb-4 fw-semibold">Integration option</h4>
...
export default Turnerc250discriptions;
