  ...
  {isMobile ? (
    <div className="mobile-layout">
      ...
      <div className="description mt-3">
        <p>
          Tripod turnstiles are essential for access management in gyms, educational institutions, office buildings, etc., ensuring smooth and controlled pedestrian flow. Application swing gate operators are suitable for residential villas, commercial, and high-traffic areas.
        </p>
      </div>
    </div>
  ) : (
    ...
    {isMobile ? (
      <>
        ...
        <div className="text-center">
          ...
          >
            <p>
              Houston's flap barrier's are designed with different dimensions, 
              and aesthetics play an important role in deciding lane configurations 
              as per site layout. These systems ensure seamless functionality, 
