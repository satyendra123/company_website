...
import Turnerc200 from "./Tripodimg/Tripodintegration/TurnerC200.png";
    ...
    <div className="sdfsd">
      <div className="card2 ">
        <div className="card-body text-center">
          <div className="p-3">
            <h4 className="card-title mb-4 custom-left fw-semibold">Turner C200 </h4>
            ...
            <div className="col-md-4 col-12 ">
              ...
              <div className="col-md-4 col-12  custom-image">
                <img src={turnerc200} className="img-fluid" alt="VEGA" />
              </div>
              <div className="col-md-4 col-12 custom-right">
                ...
                <p className="rightside_second_text">1170 x 150 x 980</p>
              </div>
            </div>
...
export default Turnerc200discriptions;
