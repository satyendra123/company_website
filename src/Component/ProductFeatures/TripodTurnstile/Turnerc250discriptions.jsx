              ...
              <div className="row ">
                ...
                <div className="col-md-6 col-12 d-flex align-items-center">
                  <div className="row justify-content-around">
                    ...
                    Tripod turnstiles are essential for access management in gyms, 
                    educational institutions, office buildings etc. ensuring smooth and controlled pedestrian flow.
                   application swing gate operators are suitable for residential villas comer
