...
import turnerec250 from "./Tripodimg/Turnerc250.png";
...
import sports_ from "./Tripodimg/sports_.png";
import entertainment_ from "./Tripodimg/entertainment_.png";
import Government_buildings from "./Tripodimg/Government_buildings.png";
import qr from "./Tripodimg/qr.png";

import keyspecies1 from './Tripodimg/key_species/Keyspecies_1.png'
import keyspecies2 from './Tripodimg/key_species/Keyspecies_2.png'
import keyspecies3 from './Tripodimg/key_species/Keyspecies_3.png'
import keyspecies4 from './Tripodimg/key_species/Keyspecies_4.png'
          ...
          <div className="p-3">
            ...
            <div className="col-md-4 col-12 ">
              ...
              <div className="col-md-4 col-12 custom-right">
                ...
                <p className="rightside_second_text">1200 x 280 x 980</p>
              </div>
            </div>
  ...
  {isMobile ? (
    <div className="mobile-layout">
      ...
      <div className="description mt-3">
        <p>
          Tripod turnstiles are essential for access management in gyms, educational institutions, office buildings, etc., ensuring smooth and controlled pedestrian flow. Application swing gate operators are suitable for residential villas, commercial properties, and high-traffic areas.
        </p>
      </div>
    </div>
  ) : (
...
<Container fluid className="py-4">
  ...
  <Row className="justify-content-center">
    <Col xs={12} className="text-center mb-4">
      <h4 className="fw-semibold">Dimensions and Layouts</h4>
    </Col>
  </Row>
    ...
    {isMobile ? (
      <>
        ...
        <div className="text-center">
          ...
          >
            <p>
              Houston's tripod turnstiles are designed to provide efficient access control, 
