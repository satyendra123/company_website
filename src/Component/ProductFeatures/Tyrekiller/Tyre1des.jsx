...
import road1des from "./TYREIMG/ROCKER B380.png";
...
import keyspecies4 from "./TYREIMG/key_species_1/key_species_5.png";
          ...
          <div className="p-3">
            ...
            <div className="row  mb-5">
              <div className="col-md-4 col-12 ">
                ...
                <p className="leftside_second_text">500W</p>
                <p className="leftside_top_text">Length</p>
                <p className="leftside_second_text">3-6 Meter</p>
                <p className="leftside_top_text">Material</p>
                <p className="leftside_second_text">Galvanised mild steel</p>
              </div>
              ...
              <div className="col-md-4 col-12 custom-right">
                <p className="rightside_top_text">Load Capacity</p>
              ...
              <div className="row ">
                ...
                <div className="col-md-6 col-12 d-flex align-items-center">
                  <div className="row justify-content-around">
                    ...
                    Road blockers are designed for high-security premises like military bases, airports, and power plants to prevent forced vehicle entry and enhance perimeter defence.
...
{/* end application  */}
  ...
  <Row className="align-items-center flex-column">
    ...
    <Col xs={12} className="text-center mb-4">
      ...
      >
        <p>
        The tyrekiller is a 3000 mm long structure with a 430 mm width and a 290 mm barrier cabinet.
         It features a drainage channel on the left side. 
         This type of barrier is used to control access or prevent unauthorized entry in high-security areas like military bases and airports.
        </p>
      </div>
    </Col>
    {/* Image Section */}
