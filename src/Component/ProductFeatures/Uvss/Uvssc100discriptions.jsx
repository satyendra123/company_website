...
import r100dimension from "./UVSSIMG/Uvssintegration/uvss3.png";
import { Container, Row, Col, Form, Button } from "react-bootstrap";
import Turnerc100 from "./UVSSIMG/Uvssintegration/uvss_dimensions.png";
    ...
    <div className="sdfsd">
      <div className="card2 ">
        <div className="card-body text-center">
          <div className="p-3">
            <h4 className="card-title mb-4 custom-left fw-semibold">SS3090F FIXED UVSS </h4>
...
export default Uvssc100discriptions;
