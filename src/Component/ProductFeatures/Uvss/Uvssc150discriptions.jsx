...
import Turnerdf150 from "./UVSSIMG/portableuvss.png";
import React, { useState,useRef, useEffect } from "react";

import { Container, Row, Col, Form, Button } from "react-bootstrap";

import r150dimension from "./UVSSIMG/Uvssintegration/uvss_yellow.png";

import Turnerc150 from "./UVSSIMG/Uvssintegration/TurnerC150.png";

import a_park from "./UVSSIMG/a_park.png";
import sports_ from "./UVSSIMG/sports_.png";
import entertainment_ from "./UVSSIMG/entertainment_.png";
import Government_buildings from "./UVSSIMG/Government_buildings.png";
import qr from "./UVSSIMG/qr.png";
...
import keyspecies1 from './UVSSIMG/key_species/Keyspecies_1.png'
import keyspecies2 from './UVSSIMG/key_species/Keyspecies_2.png'
import keyspecies3 from './UVSSIMG/key_species/Keyspecies_3.png'
import keyspecies4 from './UVSSIMG/key_species/Keyspecies_4.png'
    ...
    <div className="sdfsd">
      <div className="card2 ">
        <div className="card-body text-center">
          <div className="p-3">
            <h4 className="card-title mb-4 custom-left fw-semibold">SS2130P Portable Uvss </h4>
            <div className="row  mb-5">
            <div className="col-md-4 col-12 ">
                <p className="leftside_top_text">Sensor Type</p>
                <p className="leftside_second_text">CCD CMOS Area Sensor</p>
                <p className="leftside_top_text">Camera Resolution</p>
                <p className="leftside_second_text">1920 &times; 1200</p>
                <p className="leftside_top_text">Frame Rate</p>
                <p className="leftside_second_text">30 FPS</p>
              </div>
              ...
              <div className="col-md-4 col-12 custom-right">
                <p className="rightside_top_text">Camera Type</p>
                <p className="rightside_second_text">Area Scan Camera</p>
                <p className="rightside_top_text">Scanning Speed</p>
                <p className="rightside_second_text">15 km/hr</p>
                <p className="rightside_top_text">Dimension</p>
                <p className="rightside_second_text">1200 x 130 x 990</p>
              </div>
            </div>
...
export default Uvssc150discriptions;
