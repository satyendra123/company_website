...
import Wparkzonedisplay from './../../PGSSOLUTIONIMG/Wparkzonedisplay.png';
import Wparkfloordisplay from './../../PGSSOLUTIONIMG/Wparkfloordisplay.png';
import Wparkmaindisplay from './../../PGSSOLUTIONIMG/Wparkmaindisplay.png';
        ...
        <div className="d-flex">
          <div className={`col-12 ${!isMobileScreen ? 'col-md-6' : ''} d-flex align-items-center`}>
            <div>
              ...
              <p>
                The LED display in Parking Guidance System shows real-time parking space availability,
                helping users to find open spots quickly.
              </p>
