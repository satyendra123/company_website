...
import zonedisplay from './../../TOLLSOLUTIONIMG/tollimg/zonedisplay.png';
import floordisplay from './../../TOLLSOLUTIONIMG/tollimg/floordisplay.png';
import maindisplay from './../../TOLLSOLUTIONIMG/tollimg/maindisplay.png';
// import barriertwo from './../../TOLLSOLUTIONIMG/tollimg';
        ...
        <Slider {...sliderSettings}>
          ...
          <div className="d-flex">
            <div className="col-6 d-flex align-items-center">
              <div>
                <h3 className="">Zone Displaydsfasdfasdf</h3>
                <p>
            ...
            <div className="col-6 d-flex justify-content-end align-items-center">
              <img src={zonedisplay} alt="Validator" className="img-fluid" style={{width:"50%"}}/>
            </div>
          </div>
          ...
          <div className="d-flex">
            ...
            <div className="col-6 d-flex justify-content-end align-items-center">
              <img src={floordisplay} alt="Validator" className="img-fluid" style={{width:"50%"}}/>
            </div>
          </div>
          ...
          <div className="d-flex">
            ...
            <div className="col-6 d-flex justify-content-end align-items-center">
              <img src={maindisplay} alt="Validator" className="img-fluid"/>
            </div>
          </div>
